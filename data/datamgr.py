...
class SimpleDataManager(DataManager):  # Full class
  ...
  def get_data_loader(self, data_file, aug):
    ...
    data_loader = torch.utils.data.DataLoader(dataset, batch_size=self.batch_size, shuffle=True, num_workers = num_workers, pin_memory=True)
    return data_loader
...
class SetDataManager(DataManager):  # Few-Shot
  ...
  def get_data_loader(self, data_file, aug):
    ...
    data_loader = torch.utils.data.DataLoader(dataset, batch_sampler=sampler,  num_workers=num_workers)
    return data_loader